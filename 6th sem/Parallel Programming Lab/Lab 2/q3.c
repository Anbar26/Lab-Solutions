...
//of processes. The root process sends one value to each of the slaves. Let even ranked processes find square of the 
//received element and odd ranked process find cube of the received element. Use Buffered send.
